...
func init() {
	...
	s3Cmd.PersistentFlags().StringVarP(&s3TestConf.S3Ip, "s3_ip", "i", "", "S3 server IP address")
	s3Cmd.PersistentFlags().StringVar(&s3TestConf.S3AccessID, "s3_accesss_id", "", "S3 access ID")
